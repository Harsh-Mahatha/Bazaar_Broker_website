  ...
  useEffect(() => {
    ...
    try {
      ...
      const filtered = normalizedSkills.filter((skill) => {
        ...
        const regularTiers = selectedTiers.filter(
          (t) => t !== "Monster Drops Only"
        );
      ...
      console.log(
        `Filtered: ${filtered.length}/${filteredSkills.length} skills`
      );
    } catch (error) {
      ...
      <div className="bg-[#B1714B] p-4 rounded-lg shadow-xl w-[1200px] h-[90vh] relative flex flex-col">
        <button
          ...
          <div className="flex h-full">
            ...
            <h3 className="text-white text-xl mb-1 mt-[-7px]">Select a Skill</h3>

            <div className="text-gray-300 text-sm mb-2">
              Total skills available: {filteredSkills.length} (All Skills
              coming Soon)
            </div>
            ...
            <div className="mb-1">
              ...
              <p className="text-white text-base">Heroes</p>
              </div>
            ...
            <div className="mb-1">
              <div className="flex justify-between items-center mb-1">
              <p className="text-white text-base">Starting Tiers</p>
              </div>
